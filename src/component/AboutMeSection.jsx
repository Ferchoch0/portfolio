...
function DetailsCard({ icon: Icon ,title, description }) {
    return (
        <div className="flex flex-col justify-start items-center md:items-start w-full md:w-1/2 p-4 gap-2">
            ...
            <h2 className="text-[13px] text-center md:text-start xl:text-3xl font-bold text-white">{title}</h2>
            <p className="hidden md:block text-base xl:text-lg text-gray-400">{description}</p>
        </div>
    );
}
...
function Details(){
    return(
        <div className="flex flex-col justify-center items-center w-full min-h-screen p-6 text-white relative z-[10]"> {/* Added z-index */}
            <div className="flex md:h-[300px] w-full md:w-[75%]  xl:w-[70%] border-[1px] border-[#d896ff] rounded-md gap-4 p-4 backdrop-blur-md">
                <DetailsCard 
                    icon={FaCode}
                    title={"FullStack"}
            ...
            <div className="flex justify-between items-center w-[100%] md:w-[70%] h-full p-6 text-white mt-4 gap-4">
                <div className="flex flex-col justify-center items-start w-full md:w-[50%] h-full p-6 text-white mt-4 gap-4">
